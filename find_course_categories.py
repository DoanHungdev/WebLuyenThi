...
lines = content.split('\n')
with open(r"C:\Users\admin\.gemini\antigravity\scratch\course_categories_def.txt", "w", encoding="utf-8") as f_out:
    for idx, line in enumerate(lines):
        if "courseCategories =" in line or "const courseCategories" in line or "let courseCategories" in line:
